...
import com.hwlcn.ldap.ldap.sdk.LDAPConnectionPool;
import com.hwlcn.ldap.ldap.sdk.LDAPException;
import com.hwlcn.ldap.ldap.sdk.LDAPInterface;
import com.hwlcn.ldap.ldap.sdk.LDAPResult;
import com.hwlcn.ldap.ldap.sdk.LDAPSearchException;
...
import com.hwlcn.ldap.ldap.sdk.ReadOnlyAddRequest;
import com.hwlcn.ldap.ldap.sdk.ReadOnlyCompareRequest;
import com.hwlcn.ldap.ldap.sdk.ReadOnlyDeleteRequest;
import com.hwlcn.ldap.ldap.sdk.ReadOnlyModifyRequest;
import com.hwlcn.ldap.ldap.sdk.ReadOnlyModifyDNRequest;
import com.hwlcn.ldap.ldap.sdk.ReadOnlySearchRequest;
import com.hwlcn.ldap.ldap.sdk.ResultCode;
import com.hwlcn.ldap.ldap.sdk.RootDSE;
 ...
 *       point.</LI>
 *   <LI>It implements the {@link com.hwlcn.ldap.ldap.sdk.LDAPInterface} interface, which means that in
 *       many cases it can be used as a drop-in replacement for an
 *       {@link com.hwlcn.ldap.ldap.sdk.LDAPConnection}.</LI>
 * </UL>
 * <BR><BR>
       ...
       implements LDAPInterface
{
   ...
   *                  {@code null} or empty.
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If a problem occurs while attempting to initialize
   *                         the server.
   */
   ...
   *              {@code null}.
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If a problem occurs while trying to initialize the
   ...
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If a problem occurs while attempting to create any
   ...
   *                       be {@code null}.
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If a problem occurs while attempting to start the
   *                         requested listener.
   */
   ...
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If a problem occurs while attempting to restart any
   ...
   *                       not be {@code null}.
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If a problem occurs while attempting to restart the
   *                         specified listener.
   */
   ...
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If a problem occurs while attempting to create the
   *                         connection pool.
   */
   ...
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If a problem occurs while writing entries to LDIF.
   */
   ...
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If a problem is encountered while attempting to add
   ...
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPSearchException  If the provided string could not be parsed as

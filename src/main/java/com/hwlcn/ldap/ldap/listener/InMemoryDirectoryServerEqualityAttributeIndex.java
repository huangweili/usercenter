...
final class InMemoryDirectoryServerEqualityAttributeIndex
{
   ...
   *                        {@code null}.
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If the specified attribute type is not defined in
   *                         the schema.
   */
   ...
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If a problem is encountered (e.g., the entry has

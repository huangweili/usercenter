 ...
 * {@link com.hwlcn.ldap.ldap.listener.InMemoryDirectoryServer} class.
 * <BR><BR>
       ...
       implements Serializable, LDAPListenerExceptionHandler
{
   ...
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If a problem is encountered while creating the
   *                         configuration.
   */

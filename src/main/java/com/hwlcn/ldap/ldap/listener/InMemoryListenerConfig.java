...
public final class InMemoryListenerConfig
{
   ...
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If the provided listener name is {@code null} or
   ...
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If the provided name is {@code null}.
   */
   ...
   * @return  The newly-created listener configuration.
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If the provided name or server socket factory is

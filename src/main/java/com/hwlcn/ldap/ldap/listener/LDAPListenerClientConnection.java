...
import com.hwlcn.ldap.ldap.protocol.IntermediateResponseProtocolOp;
...
import com.hwlcn.ldap.ldap.protocol.SearchResultEntryProtocolOp;
...
import com.hwlcn.ldap.ldap.sdk.LDAPRuntimeException;
 ...
 * a client accepted by an {@link com.hwlcn.ldap.ldap.listener.LDAPListener}, although connections may also
       ...
       extends Thread
{
   ...
   *                           {@link com.hwlcn.ldap.ldap.listener.LDAPListenerRequestHandler#newInstance}
   ...
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If a problem occurs while preparing this client
   ...
   *
   * @throws  java.io.IOException  If a problem occurs while closing the socket.
   */
   ...
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If a problem occurs while attempting to send the
   *                         response to the client.
   */
   ...
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If a problem is encountered while trying to convert

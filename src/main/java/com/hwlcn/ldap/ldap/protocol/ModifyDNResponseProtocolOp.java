       ...
       extends GenericResponseProtocolOp
{
  ...
  public ASN1Element encodeProtocolOp()
  {
    ...
    return new ASN1Sequence(LDAPMessage.PROTOCOL_OP_TYPE_MODIFY_DN_RESPONSE,
         elements);
  }
         ...
         throws LDAPException
  {
    try
    {
      ...
      return new ModifyDNResponseProtocolOp(resultCode, matchedDN,
    ...
    catch (final Exception e)
    {
      ...
      throw new LDAPException(ResultCode.DECODING_ERROR,
           ERR_MODIFY_DN_RESPONSE_CANNOT_DECODE.get(

       ...
       implements LDAPInterface
{
   ...
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If no connection is available, or a problem occurs
   ...
   *          connection.
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If a problem is encountered while trying to create
   ...
   *          connection.
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If an exception is encountered while attempting to
   ...
   * context pool (e.g., using methods that are part of {@link com.hwlcn.ldap.ldap.sdk.LDAPInterface}),
   ...
   * basis via the {@link #setRetryFailedOperationsDueToInvalidConnections(java.util.Set)}
   ...
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPSearchException  If the search does not complete successfully,
   ...
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPSearchException  If the provided string does not represent a
   *                               valid search filter.
   */
   ...
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If a problem occurs while trying to obtain a
...
requestLoop:
   ...
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  To indicate that a problem occurred during LDAP
   ...
   * @param  conn  The connection to be released to the pool.
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPSearchException  To indicate that a problem occurred during

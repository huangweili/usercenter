 ...
 * then it is recommended that the simpler {@link com.hwlcn.ldap.ldap.sdk.LDAPConnectionPool} class be
 * used instead.
 * <BR><BR>
 ...
 * for the {@link com.hwlcn.ldap.ldap.sdk.LDAPConnectionPool} class for additional documentation and
       ...
       implements LDAPInterface
{
   ...
   *                                  initial number of write connections.
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If either of the provided connections cannot be
   ...
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If no read connection is available, or a problem
   ...
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If no write connection is available, or a problem
   *                         occurs while creating a new connection to return.
   */

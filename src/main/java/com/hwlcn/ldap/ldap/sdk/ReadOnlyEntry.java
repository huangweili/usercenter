...
/**
 * This class defines an {@link com.hwlcn.ldap.ldap.sdk.Entry} subclass in which the contents of the
       ...
       extends Entry
{
  ...
  /**
   * Creates a new read-only entry from the provided {@link com.hwlcn.ldap.ldap.sdk.Entry}.
   *

 ...
 * {@link com.hwlcn.ldap.ldap.sdk.controls.ContentSyncRequestMode#REFRESH_AND_PERSIST} mode is selected), may
 ...
 *       {@link com.hwlcn.ldap.ldap.sdk.SearchResultListener} so that entries
 ...
 *       {@link com.hwlcn.ldap.ldap.sdk.AsyncSearchResultListener} to perform the
 ...
 *       {@link com.hwlcn.ldap.ldap.sdk.controls.ContentSyncStateControl} with the associated entryUUID and
 ...
 *       {@link com.hwlcn.ldap.ldap.sdk.SearchResult} (or
 *       {@link com.hwlcn.ldap.ldap.sdk.LDAPSearchException} if the search ended
 *       with a non-success response) may include a
 *       {@link com.hwlcn.ldap.ldap.sdk.controls.ContentSyncDoneControl} with updated sync state information.
 *       You should call

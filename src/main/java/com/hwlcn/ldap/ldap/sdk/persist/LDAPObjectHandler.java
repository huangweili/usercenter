 ...
 * objects marked with the {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPObject} annotation type.
 *
       ...
       implements Serializable
{
  ...
  /**
   * Retrieves the {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPObject} annotation for the associated class.
   *
   ...
   * does not have a field marked with either the {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPDNField} or
   * {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPEntryField} annotation.
   *
   ...
   * the associated class has a field marked with the {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPEntryField}
   * annotation.
   *
   ...
   * {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPDNField} or {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPEntryField} annotation, then the actual
   ...
   *                   as defined in the {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPObject} annotation will be
   ...
   * object was retrieved from the directory using the persistence framework and
   * includes a field with the {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPEntryField} annotation, then that
   ...
   * with a non-{@code null} value and that have a {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPField} annotation
   * with the {@code inFilter} element set to {@code true}, and all  getter
   * methods that return a non-{@code null} value and have a
   * {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPGetter} annotation with the {@code inFilter} element set to
   * {@code true}.
   *

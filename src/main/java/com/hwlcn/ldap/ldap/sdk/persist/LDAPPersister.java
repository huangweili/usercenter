 ...
 * update, and retrieve must be marked with the {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPObject} annotation.
 * Fields and methods within the class should be marked with the
 * {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPField}, {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPGetter}, or {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPSetter}
       ...
       implements Serializable
{
  ...
  /**
   * Retrieves the {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPObject} annotation of the class used for objects
   ...
   * {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPObject} annotation and the fields, getters, and setters used
   * by the object.
   *
   ...
   *                   {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPDNField} or {@link LDAPEntryField} annotation,
   ...
   *                   the default parent DN defined in the {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPObject}
   ...
   *                   have a field with either the {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPDNField} or
   ...
   *                           {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPDNField} or {@link LDAPEntryField}
   *                           annotation.
   * @param  deleteNullValues  Indicates whether to include modifications that
   *                           may completely remove an attribute from the
   *                           entry if the corresponding field or getter method
   ...
   * {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPDNField} or {@link LDAPEntryField}, then that field will be used
   ...
   *                   {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPObject#defaultParentDN} element in the
   ...
   *                   {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPObject} annotation will be used.
   *
   ...
   * methods whose {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPField} or {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPGetter} annotation has
   * the {@code inFilter} element set to {@code true}.
   * <BR><BR>
   * The search performed will be a subtree search using a base DN equal to the
   * {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPObject#defaultParentDN} element in the {@code LDAPObject}
   ...
   * {@link com.hwlcn.ldap.ldap.sdk.LDAPConnectionOptions#setUseSynchronousMode}
   * option).
   *
   ...
   *                 if the {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPObject#defaultParentDN} element in the
   *                 {@code LDAPObject} should be used as the base DN.
   ...
   *                      {@code null} if the {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPObject#defaultParentDN}
   ...
   * {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPField} or {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPGetter} annotation has the {@code inFilter}

       ...
       implements Serializable
{
   ...
   *            definition.  It will include the {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPField} annotation
   *            type.
   *
   ...
   *            definition.  It will include the {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPGetter}
   *            annotation type.
   *
   * @return  The constructed attribute type definition.
   *
   ...
   *                marked with the {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPField} annotation.
   *
   ...
   *                 must be marked with the {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPSetter} annotation
   ...
   *            {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPField} annotation.
   * @param  o  The object to be updated.  It must not be {@code null}, and the
   *            class must be marked with the {@link com.hwlcn.ldap.ldap.sdk.persist.LDAPObject annotation}.
   *
   * @throws  LDAPPersistException  If a problem occurs while attempting to

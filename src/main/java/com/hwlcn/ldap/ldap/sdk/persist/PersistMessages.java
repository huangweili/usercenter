 ...
 * com.hwlcn.ldap.ldap.sdk.persist package, which correspond to messages in the
 * ldap-ldapsdk-persist.properties properties file.
 * <BR><BR>
...
enum PersistMessages
{
  ...
  /**
   * Class {0} includes the @LDAPEntryField annotation for field {1} of type {2} which is not an allowed type for entry fields.  Entry fields must have a type of com.hwlcn.ldap.ldap.sdk.ReadOnlyEntry.
   */
  ERR_OBJECT_HANDLER_INVALID_ENTRY_FIELD_TYPE("Class {0} includes the @LDAPEntryField annotation for field {1} of type {2} which is not an allowed type for entry fields.  Entry fields must have a type of com.hwlcn.ldap.ldap.sdk.ReadOnlyEntry."),
  ...
  static
  {
    ...
    try
    {
      rb = ResourceBundle.getBundle("ldap-ldapsdk-persist");
    } catch (Exception e) {}
    RESOURCE_BUNDLE = rb;
  }
   ...
   */
  private static final ConcurrentHashMap<PersistMessages,String> MESSAGE_STRINGS = new ConcurrentHashMap<PersistMessages,String>();
   ...
   */
  private static final ConcurrentHashMap<PersistMessages,MessageFormat> MESSAGES = new ConcurrentHashMap<PersistMessages,MessageFormat>();

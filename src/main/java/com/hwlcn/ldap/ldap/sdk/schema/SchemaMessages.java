 ...
 * com.hwlcn.ldap.ldap.sdk.schema package, which correspond to messages in the
 * ldap-ldapsdk-schema.properties properties file.
 * <BR><BR>
...
enum SchemaMessages
{
  ...
  static
  {
    ...
    try
    {
      rb = ResourceBundle.getBundle("ldap-ldapsdk-schema");
    } catch (Exception e) {}
    RESOURCE_BUNDLE = rb;
  }

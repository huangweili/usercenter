       ...
       implements LDIFRecord
{
   ...
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If an error occurs while processing this change
   ...
   *
   * @throws  com.hwlcn.ldap.ldif.LDIFException  If this change record cannot be represented as a
   *                         valid entry.
   */
  final Entry toEntry()

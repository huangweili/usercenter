...
public final class LDIFReader
{
   ...
   *
   * @throws  java.io.IOException  If a problem occurs while opening the file for
   *                       reading.
   */
   ...
   *                       reading.
   *
   * @see #LDIFReader(java.io.BufferedReader, int, LDIFReaderEntryTranslator)
   ...
   *
   * @throws  java.io.IOException  If a problem occurs while attempting to read data
   ...
   *
   * @throws  java.io.IOException  If a problem was encountered while attempting to read
   ...
   *
   * @throws  java.io.IOException  If a problem occurs while trying to read from the
   *                       LDIF source.
   *
   ...
   *          no more entries to be read.
   *
   * @throws  java.io.IOException  If a problem occurs while attempting to read from the
   *                       LDIF source.
   *
   ...
   *          records to read.
   *
   * @throws java.io.IOException  If IOException was thrown when reading or parsing
   *                      the record.
   *
   ...
   *           is thrown.
   *
   * @throws java.io.IOException   If t is an IOException or a checked Exception that

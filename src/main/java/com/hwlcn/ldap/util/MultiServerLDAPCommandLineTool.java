...
import com.hwlcn.ldap.ldap.sdk.PostConnectProcessor;
import com.hwlcn.ldap.ldap.sdk.ResultCode;
import com.hwlcn.ldap.ldap.sdk.ServerSet;
import com.hwlcn.ldap.ldap.sdk.SimpleBindRequest;
import com.hwlcn.ldap.ldap.sdk.SingleServerSet;
import com.hwlcn.ldap.ldap.sdk.StartTLSPostConnectProcessor;
...
import com.hwlcn.ldap.util.args.DNArgument;
import com.hwlcn.ldap.util.args.FileArgument;
import com.hwlcn.ldap.util.args.IntegerArgument;
import com.hwlcn.ldap.util.args.StringArgument;
import com.hwlcn.ldap.util.ssl.KeyStoreKeyManager;
import com.hwlcn.ldap.util.ssl.PromptTrustManager;
import com.hwlcn.ldap.util.ssl.SSLUtil;
import com.hwlcn.ldap.util.ssl.TrustAllTrustManager;
import com.hwlcn.ldap.util.ssl.TrustStoreTrustManager;
       ...
       extends CommandLineTool
{
   ...
   *                             used.
   *
   * @throws  com.hwlcn.ldap.util.LDAPSDKUsageException  If both the sets of server name prefixes
   ...
   *
   * @throws  com.hwlcn.ldap.util.args.ArgumentException  If a problem occurs while adding the arguments.
   */
   ...
   * before the {@link com.hwlcn.ldap.util.CommandLineTool#doToolProcessing} method is invoked.
   *
   * @throws  com.hwlcn.ldap.util.args.ArgumentException  If there was a problem with the command-line
   ...
   *          directory server.
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If a problem occurs while creating the connection.
   */
   ...
   *          pools.
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If a problem occurs while creating the server set.
   */
   ...
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If a problem occurs while creating the SSLUtil
   *                         instance.
   */
   ...
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If a problem occurs while creating the bind
   *                         request.
   */

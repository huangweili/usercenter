...
public final class SASLUtils
{
   ...
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If a problem is encountered while parsing options.
   */
   ...
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If the map of SASL options is not empty.
   */
  @InternalUseOnly()
   ...
   *
   * @throws  com.hwlcn.ldap.ldap.sdk.LDAPException  If the option value cannot be parsed as a boolean.
   */

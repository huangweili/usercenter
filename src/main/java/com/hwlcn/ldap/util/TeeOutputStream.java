       ...
       extends OutputStream
{
   ...
   *
   * @throws  java.io.IOException  If a problem occurs while writing the provided byte
   ...
   *
   * @throws  java.io.IOException  If a problem occurs while writing the provided data
   *                       to any of the target output streams.
   */
  @Override()
   ...
   * be written out.
   *
   * @throws  java.io.IOException  If a problem occurs while flushing any of the target
   *                       output streams.
   */
  @Override()
  public void flush()
   ...
   *
   * @throws  java.io.IOException  If a problem occurs while closing any of the target

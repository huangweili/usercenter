 ...
 * {@link com.hwlcn.security.subject.Subject#isRemembered()} JavaDoc for an in-depth explanation of the semantic
 * differences of what it means to be remembered vs. authenticated.
 *
 * @see com.hwlcn.security.subject.Subject#isRemembered()
 * @since 0.9
 */

...
/**
 * Simple implementation of the {@link Account} interface that
...
public class SimpleAccount implements Account, MergableAuthenticationInfo, SaltedAuthenticationInfo, Serializable {
     ...
     * {@link com.hwlcn.security.realm.SimpleAccountRealm}.
     */
     ...
     * @param realmName         the name of the realm that accesses this account data
     * @see com.hwlcn.security.authc.credential.HashedCredentialsMatcher HashedCredentialsMatcher
     * @since 1.1
     */

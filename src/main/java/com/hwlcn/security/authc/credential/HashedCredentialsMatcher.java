 ...
 * Shiro's Hash implementations (for example, {@link com.hwlcn.security.crypto.hash.Md5Hash Md5Hash},
 * {@link com.hwlcn.security.crypto.hash.Sha1Hash Sha1Hash}, etc) support salting and multiple hash iterations via
 ...
 * {@link #getSalt(com.hwlcn.security.authc.AuthenticationToken) getSalt(AuthenticationToken)} method.  This however
 ...
 * <p/>
 * To enable this, {@code Realm}s should return {@link com.hwlcn.security.authc.SaltedAuthenticationInfo SaltedAuthenticationInfo} instances
 * during authentication.  {@code HashedCredentialsMatcher} implementations will then use the provided
 * {@link com.hwlcn.security.authc.SaltedAuthenticationInfo#getCredentialsSalt credentialsSalt} for hashing.  To avoid
 * security risks,
 * <b>it is highly recommended that any existing {@code Realm} implementations that support hashed credentials are
 * updated to return {@link com.hwlcn.security.authc.SaltedAuthenticationInfo SaltedAuthenticationInfo} instances as soon as possible</b>.
 ...
 * be updated to return {@link com.hwlcn.security.authc.SaltedAuthenticationInfo SaltedAuthenticationInfo} instances as
 * soon as possible.
 * <p/>
 ...
 * {@link com.hwlcn.security.authc.SaltedAuthenticationInfo SaltedAutenticationInfo} instances and {@link #isHashSalted() hashSalted} is
 * {@code true}.
 ...
 *
 * @see com.hwlcn.security.crypto.hash.Md5Hash
 * @see com.hwlcn.security.crypto.hash.Sha1Hash
 * @see com.hwlcn.security.crypto.hash.Sha256Hash
 * @since 0.9
 */
public class HashedCredentialsMatcher extends SimpleCredentialsMatcher {
     ...
     * credentials.
     *
     * @param hashAlgorithmName the {@code Hash} {@link com.hwlcn.security.crypto.hash.Hash#getAlgorithmName() algorithmName}
    ...
    /**
     * Returns the {@code Hash} {@link com.hwlcn.security.crypto.hash.Hash#getAlgorithmName() algorithmName} to use
     * when performing hashes for credentials matching.
     *
     * @return the {@code Hash} {@link com.hwlcn.security.crypto.hash.Hash#getAlgorithmName() algorithmName} to use
     *         when performing hashes for credentials matching.
     * @since 1.1
     */
    ...
    /**
     * Sets the {@code Hash} {@link com.hwlcn.security.crypto.hash.Hash#getAlgorithmName() algorithmName} to use
     * when performing hashes for credentials matching.
     *
     * @param hashAlgorithmName the {@code Hash} {@link com.hwlcn.security.crypto.hash.Hash#getAlgorithmName() algorithmName}
     *                          to use when performing hashes for credentials matching.
     ...
     *             returned from the {@code Realm} is a {@link com.hwlcn.security.authc.SaltedAuthenticationInfo} instance and its
     *             {@link com.hwlcn.security.authc.SaltedAuthenticationInfo#getCredentialsSalt() getCredentialsSalt()} method returns a non-null value.
     ...
     *             that support hashed credentials start returning {@link com.hwlcn.security.authc.SaltedAuthenticationInfo SaltedAuthenticationInfo}
     ...
     * <p/>
     * If enabled, the salt used will be obtained via the {@link #getSalt(com.hwlcn.security.authc.AuthenticationToken) getCredentialsSalt} method.
     * </p>
     * The default value is {@code false}.
     *
     ...
     * {@link com.hwlcn.security.authc.SaltedAuthenticationInfo SaltedAuthenticationInfo}.  It then compares the hash
     * against the {@code AuthenticationInfo}'s
     * {@link #getCredentials(com.hwlcn.security.authc.AuthenticationInfo) already-hashed credentials}.  This method
     ...
     * {@code info} instance is an {@code instanceof} {@link com.hwlcn.security.authc.SaltedAuthenticationInfo SaltedAuthenticationInfo} (see
     ...
     * {@link SimpleCredentialsMatcher#getCredentials(com.hwlcn.security.authc.AuthenticationInfo) getCredentials(AuthenticationInfo)} implementation.
     *

...
public interface HashingPasswordService extends PasswordService {
     ...
     * {@link com.hwlcn.security.util.ByteSource.Util#isCompatible(Object)} is valid.
     * <p/>
     * Regardless of your choice of using Strings or character arrays to represent submitted passwords, you can wrap
     * either as a {@code ByteSource} by using {@link com.hwlcn.security.util.ByteSource.Util}, for example, when the passwords are captured as
     * Strings:
     * <pre>
     ...
     * </pre>
     *
     * @param plaintext the raw password as 'byte-backed' object (String, character array, {@link com.hwlcn.security.util.ByteSource},
     ...
     *                                  {@link com.hwlcn.security.util.ByteSource.Util#isCompatible(Object)}.
     * @see com.hwlcn.security.util.ByteSource.Util#isCompatible(Object)

...
public class SimpleCredentialsMatcher extends CodecSupport implements CredentialsMatcher {
     ...
     * {@link com.hwlcn.security.authc.AuthenticationToken#getCredentials() authenticationToken.getCredentials()} and exists as a template hook
     ...
     * <p/>
     * <p>This default implementation merely returns
     * {@link com.hwlcn.security.authc.AuthenticationInfo#getCredentials() account.getCredentials()} and exists as a template hook if subclasses
     ...
     * are compared via {@link java.util.Arrays#equals(byte[], byte[]) Arrays.equals(byte[],byte[])}.</p>
     * <p/>
     ...
     * (via {@link #getCredentials(com.hwlcn.security.authc.AuthenticationInfo) getCredentials(account)}) and then passes both of

 ...
 * {@link com.hwlcn.security.realm.Realm}s.  This enables PAM (Pluggable Authentication Module) behavior in Shiro.
 ...
 * {@link com.hwlcn.security.realm.Realm#getAuthenticationInfo(com.hwlcn.security.authc.AuthenticationToken)} method.
 * <p/>
...
public class ModularRealmAuthenticator extends AbstractAuthenticator {
     ...
     * {@link Realm}s.  For each realm, first the {@link Realm#supports(com.hwlcn.security.authc.AuthenticationToken)}
     * method will be called to determine if the realm supports the {@code authenticationToken} method argument.
     * <p/>
     * If a realm does support
     * the token, its {@link Realm#getAuthenticationInfo(com.hwlcn.security.authc.AuthenticationToken)}
     ...
     * an {@link com.hwlcn.security.authc.AuthenticationException} will be thrown to indicate that the user could not be authenticated.
     * <p/>
     ...
     * @throws com.hwlcn.security.authc.AuthenticationException if the user could not be authenticated or the user is denied authentication

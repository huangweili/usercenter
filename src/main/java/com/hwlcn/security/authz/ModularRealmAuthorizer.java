...
public class ModularRealmAuthorizer implements Authorizer, PermissionResolverAware, RolePermissionResolverAware {
    ...
    /**
     * Sets the specified {@link com.hwlcn.security.authz.permission.PermissionResolver PermissionResolver} on <em>all</em> of the wrapped realms that
     * implement the {@link com.hwlcn.security.authz.permission.PermissionResolverAware PermissionResolverAware} interface.
     * <p/>
     ...
     *                           {@link com.hwlcn.security.authz.permission.PermissionResolverAware PermissionResolverAware} interface.
     */
     ...
     * {@link #getRealms Realms} that implement the {@link com.hwlcn.security.authz.permission.PermissionResolverAware PermissionResolverAware} interface.
     * <p/>
     * This method is called after setting a permissionResolver on this ModularRealmAuthorizer via the
     * {@link #setPermissionResolver(com.hwlcn.security.authz.permission.PermissionResolver) setPermissionResolver} method.
     * <p/>
    ...
    /**
     * Sets the specified {@link com.hwlcn.security.authz.permission.RolePermissionResolver RolePermissionResolver} on <em>all</em> of the wrapped realms that
     * implement the {@link com.hwlcn.security.authz.permission.RolePermissionResolverAware PermissionResolverAware} interface.
     * <p/>
     * Only call this method if you want the permission resolver to be passed to all realms that implement the
     ...
     *                               {@link com.hwlcn.security.authz.permission.RolePermissionResolverAware RolePermissionResolverAware} interface.
     */
     ...
     * {@link #getRealms Realms} that implement the {@link com.hwlcn.security.authz.permission.RolePermissionResolverAware RolePermissionResolverAware} interface.
     * <p/>
     * This method is called after setting a rolePermissionResolver on this ModularRealmAuthorizer via the
     * {@link #setRolePermissionResolver(com.hwlcn.security.authz.permission.RolePermissionResolver) setRolePermissionResolver} method.
     * <p/>
     * It is also called after setting one or more realms via the {@link #setRealms setRealms} method to allow these
     ...
     * {@link #isPermitted(com.hwlcn.security.subject.PrincipalCollection, String)} returns <code>true</code>,
    ...
    /**
     * Returns <code>true</code> if any of the configured realms'
     * {@link #isPermitted(com.hwlcn.security.subject.PrincipalCollection, Permission)} call returns <code>true</code>,
     * <code>false</code> otherwise.
     */
    ...
    /**
     * Returns <code>true</code> if any of the configured realms'
     * {@link #isPermittedAll(com.hwlcn.security.subject.PrincipalCollection, String...)} call returns
    ...
    /**
     * Returns <code>true</code> if any of the configured realms'
     * {@link #isPermitted(com.hwlcn.security.subject.PrincipalCollection, java.util.List)} call returns <code>true</code>,
     * <code>false</code> otherwise.
     */
    ...
    /**
     * Returns <code>true</code> if any of the configured realms'
     * {@link #isPermitted(com.hwlcn.security.subject.PrincipalCollection, String)} call returns <code>true</code>
    ...
    /**
     * If !{@link #isPermitted(com.hwlcn.security.subject.PrincipalCollection, String) isPermitted(permission)}, throws
    ...
    /**
     * If !{@link #isPermitted(com.hwlcn.security.subject.PrincipalCollection, Permission) isPermitted(permission)}, throws
     * an <code>UnauthorizedException</code> otherwise returns quietly.
     */
    ...
    /**
     * If !{@link #isPermitted(com.hwlcn.security.subject.PrincipalCollection, String...) isPermitted(permission)},
    ...
    /**
     * If !{@link #isPermitted(com.hwlcn.security.subject.PrincipalCollection, Permission) isPermitted(permission)} for
    ...
    /**
     * Returns <code>true</code> if any of the configured realms'
     * {@link #hasRole(com.hwlcn.security.subject.PrincipalCollection, String)} call returns <code>true</code>,
     * <code>false</code> otherwise.
     */
    ...
    /**
     * Calls {@link #hasRole(com.hwlcn.security.subject.PrincipalCollection, String)} for each role name in the specified
     ...
     * {@link #hasRole(com.hwlcn.security.subject.PrincipalCollection, String)} call returns <code>true</code> for
    ...
    /**
     * If !{@link #hasRole(com.hwlcn.security.subject.PrincipalCollection, String) hasRole(role)}, throws
     * an <code>UnauthorizedException</code> otherwise returns quietly.
     */
    ...
    /**
     * Calls {@link #checkRole(com.hwlcn.security.subject.PrincipalCollection, String) checkRole} for each role specified.
     */

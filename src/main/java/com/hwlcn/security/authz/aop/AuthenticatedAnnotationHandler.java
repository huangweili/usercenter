...
public class AuthenticatedAnnotationHandler extends AuthorizingAnnotationHandler {
     ...
     * {@link com.hwlcn.security.authz.annotation.RequiresAuthentication RequiresAuthentication} annotations.
     */
     ...
     * {@link com.hwlcn.security.authz.UnauthenticatedException UnauthenticatedException} indicating the method is not allowed to be executed.
     *
     * @param a the annotation to inspect
     * @throws com.hwlcn.security.authz.UnauthenticatedException if the calling <code>Subject</code> has not yet
     * authenticated.
     */

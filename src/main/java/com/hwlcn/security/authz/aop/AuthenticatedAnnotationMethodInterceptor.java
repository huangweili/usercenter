...
/**
 * Checks to see if a @{@link com.hwlcn.security.authz.annotation.RequiresAuthentication RequiresAuthenticated} annotation
 * is declared, and if so, ensures the calling
 * <code>Subject</code>.{@link com.hwlcn.security.subject.Subject#isAuthenticated() isAuthenticated()} before invoking
 * the method.
 *
 * @since 0.9.0
 */
public class AuthenticatedAnnotationMethodInterceptor extends AuthorizingAnnotationMethodInterceptor {
     ...
     * {@link com.hwlcn.security.authz.annotation.RequiresAuthentication RequiresAuthentication} annotations in a method
     * declaration.
     */

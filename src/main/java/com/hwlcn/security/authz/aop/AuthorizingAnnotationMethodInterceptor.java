...
public abstract class AuthorizingAnnotationMethodInterceptor extends AnnotationMethodInterceptor
{
     ...
     * {@link #assertAuthorized(com.hwlcn.security.aop.MethodInvocation) assertAuthorized} method first.
     *
     * @param methodInvocation the method invocation to check for authorization prior to allowing it to proceed/execute.
     * @return the return value from the method invocation (the value of {@link com.hwlcn.security.aop.MethodInvocation#proceed() MethodInvocation.proceed()}).
     * @throws com.hwlcn.security.authz.AuthorizationException if the <code>MethodInvocation</code> is not allowed to proceed.
     ...
     * calling {@link #getAnnotation(com.hwlcn.security.aop.MethodInvocation) getAnnotation(methodInvocation)} and then calls
     ...
     * @throws com.hwlcn.security.authz.AuthorizationException if the method invocation is not allowed to continue/execute.
     */

...
public abstract class AuthorizingMethodInterceptor extends MethodInterceptorSupport {
    ...
    /**
     * Invokes the specified method (<code>methodInvocation.{@link com.hwlcn.security.aop.MethodInvocation#proceed proceed}()</code>
     * if authorization is allowed by first
     * calling {@link #assertAuthorized(com.hwlcn.security.aop.MethodInvocation) assertAuthorized}.
     */
     ...
     * @throws com.hwlcn.security.authz.AuthorizationException if the <code>methodInvocation</code> should not be allowed to continue/execute.
     */

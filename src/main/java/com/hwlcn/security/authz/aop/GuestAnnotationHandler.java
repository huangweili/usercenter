...
/**
 * Checks to see if a @{@link com.hwlcn.security.authz.annotation.RequiresGuest RequiresGuest} annotation
 * is declared, and if so, ensures the calling <code>Subject</code> does <em>not</em>
 * have an {@link com.hwlcn.security.subject.Subject#getPrincipal() identity} before invoking the method.
 * <p>
...
public class GuestAnnotationHandler extends AuthorizingAnnotationHandler {
     ...
     *
     * {@link com.hwlcn.security.authz.annotation.RequiresGuest RequiresGuest} annotations in a method
     * declaration.
     */
     ...
     * have an {@link com.hwlcn.security.subject.Subject#getPrincipal() identity} before continuing.  If they are
     * a user ({@link com.hwlcn.security.subject.Subject#getPrincipal() Subject.getPrincipal()} != null), an

 ...
 * an in-memory {@link java.util.concurrent.ConcurrentMap ConcurrentMap}.  {@code Cache} instance creation is left to subclasses via
...
public abstract class AbstractCacheManager implements CacheManager, Destroyable {
    ...
    /**
     * Cleanup method that first {@link com.hwlcn.security.util.LifecycleUtils#destroy destroys} all of it's managed caches and then

 ...
 * {@link com.hwlcn.security.util.SoftHashMap SoftHashMap}s which auto-size themselves based on the runtime environment's memory
...
public class MemoryConstrainedCacheManager extends AbstractCacheManager {
    ...
    /**
     * Returns a new {@link MapCache MapCache} instance backed by a {@link com.hwlcn.security.util.SoftHashMap}.
     *
     * @param name the name of the cache
     * @return a new {@link MapCache MapCache} instance backed by a {@link com.hwlcn.security.util.SoftHashMap}.
     */
    @Override

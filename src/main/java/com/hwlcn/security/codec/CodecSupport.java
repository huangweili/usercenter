...
public abstract class CodecSupport {
     ...
     * wrap any {@link java.io.UnsupportedEncodingException} with a nicer runtime {@link CodecException}, allowing you to
     ...
     * <li>{@code byte[]}</li>
     * <li>{@code char[]}</li>
     * <li>{@link com.hwlcn.security.util.ByteSource}</li>
     * <li>{@link String}</li>
     ...
     * <p/>
     * If the argument is a {@code byte[]}, {@code char[]}, {@link com.hwlcn.security.util.ByteSource}, {@link String}, {@link java.io.File}, or
     * {@link java.io.InputStream}, it will be converted automatically and returned.}
     * <p/>
    ...
    /**
     * Converts the specified {@link java.io.InputStream InputStream} into a byte array.
     *
     ...
     * @throws CodecException           if there is any problem reading from the {@link java.io.InputStream}.
     * @since 1.0
     */

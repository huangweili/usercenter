 ...
 * {@link Runnable} instances with the currently available {@link com.hwlcn.security.subject.Subject} and then
 * dispatch the Subject-enabled runnable to an underlying delegate {@link java.util.concurrent.Executor}
 * instance.
 * <p/>
 ...
 * {@link com.hwlcn.security.subject.Subject#associateWith(Runnable)} method and dispatch to a Thread manually.  This
 ...
 * {@link Runnable Runnable} work = subject.{@link com.hwlcn.security.subject.Subject#associateWith(Runnable) associateWith(applicationWork)};
 * {@link java.util.concurrent.Executor anExecutor}.{@link java.util.concurrent.Executor#execute(Runnable) execute(work)};
 * </pre>
...
public class SubjectAwareExecutor implements Executor {
     ...
     * {@code SecurityUtils}.{@link com.hwlcn.security.SecurityUtils#getSubject() getSubject()}.
     *
     ...
     * return subject.{@link com.hwlcn.security.subject.Subject#associateWith(Runnable) associateWith(r)};
     * </pre>
     *
     ...
     * dispatches the associated Runnable to the underlying target {@link java.util.concurrent.Executor} instance.
     *

...
public abstract class JcaCipherService implements CipherService {
     ...
     * {@link java.security.Key key} instance</li>
     * <li>{@link #init(javax.crypto.Cipher, int, java.security.Key, java.security.spec.AlgorithmParameterSpec, java.security.SecureRandom) Initializes}

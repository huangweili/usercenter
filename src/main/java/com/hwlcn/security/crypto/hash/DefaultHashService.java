 ...
 * {@link #setPrivateSalt(com.hwlcn.security.util.ByteSource) privateSalt}.
 ...
 * {@link #setRandomNumberGenerator(com.hwlcn.security.crypto.RandomNumberGenerator) randomNumberGenerator} property.
 ...
 * {@link #setPrivateSalt(com.hwlcn.security.util.ByteSource) private salt}:
 * <p/>
...
public class DefaultHashService implements ConfigurableHashService {
     ...
     * <li>{@link #setRandomNumberGenerator(com.hwlcn.security.crypto.RandomNumberGenerator) randomNumberGenerator} =
     ...
     * {@link #setPrivateSalt(com.hwlcn.security.util.ByteSource) privateSalt} and significantly increase the number of
     ...
     * <ul>
     * <li>If the request's {@link HashRequest#getSalt() salt} is null:
     * <p/>
     ...
     * <li>{@link #combine(com.hwlcn.security.util.ByteSource, com.hwlcn.security.util.ByteSource) combine} this random salt with any configured
     ...
     * previously computed hash).  The request salt will be {@link #combine(com.hwlcn.security.util.ByteSource, com.hwlcn.security.util.ByteSource) combined} with any

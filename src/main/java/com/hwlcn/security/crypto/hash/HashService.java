 ...
 * ByteSource randomSalt = {@link com.hwlcn.security.crypto.RandomNumberGenerator randomNumberGenerator}.nextBytes();
...
public interface HashService {
     ...
     * (i.e. <code>returnedHash.{@link Hash#getSalt() getSalt()} != null</code>), this

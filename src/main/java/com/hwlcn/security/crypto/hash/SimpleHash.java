...
public class SimpleHash extends AbstractHash {
     ...
     * is not, a {@link com.hwlcn.security.crypto.UnknownAlgorithmException} will be thrown when the hash is performed (not at instantiation).
     *
     * @param algorithmName the {@link java.security.MessageDigest MessageDigest} algorithm name to use when
     *                      performing the hash.
     * @see com.hwlcn.security.crypto.UnknownAlgorithmException
     */
     ...
     * @throws com.hwlcn.security.codec.CodecException
     *          if the specified {@code source} cannot be converted into a byte array (byte[]).
     * @throws com.hwlcn.security.crypto.UnknownAlgorithmException
     *          if the {@code algorithmName} is not available.
     */
     ...
     * {@link java.io.InputStream InputStream} or {@link com.hwlcn.security.util.ByteSource ByteSource}.  If either
     * argument is anything other than these types a {@link com.hwlcn.security.codec.CodecException CodecException}
     * will be thrown.
     * <p/>

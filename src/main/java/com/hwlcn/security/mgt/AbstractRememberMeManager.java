 ...
 * {@link #setSerializer(com.hwlcn.security.io.Serializer) serialization} and
 ...
 * {@code CipherService}'s {@link com.hwlcn.security.crypto.AesCipherService#generateNewKey() generateNewKey} method
...
public abstract class AbstractRememberMeManager implements RememberMeManager {
    ...
    /**
     * Default constructor that initializes a {@link com.hwlcn.security.io.DefaultSerializer} as the {@link #getSerializer() serializer} and
     ...
     * {@link com.hwlcn.security.io.DefaultSerializer}.
     *
     ...
     * persistent remember me storage.
     * <p/>
     * Unless overridden by this method, the default instance is a {@link com.hwlcn.security.io.DefaultSerializer}.
     *
     ...
     * <li>{@code token}.{@link com.hwlcn.security.authc.RememberMeAuthenticationToken#isRememberMe() isRememberMe()} is
     * {@code true}</li>
     * </ol>
     *
     ...
     * {@link #isRememberMe(com.hwlcn.security.authc.AuthenticationToken) is a RememberMe} token, the associated identity
     * will be {@link #rememberIdentity(com.hwlcn.security.subject.Subject, com.hwlcn.security.authc.AuthenticationToken, com.hwlcn.security.authc.AuthenticationInfo) remembered}
     ...
     * {@link #rememberIdentity(com.hwlcn.security.subject.Subject, com.hwlcn.security.subject.PrincipalCollection)}.
     * <p/>
    ...
    /**
     * Returns {@code info}.{@link com.hwlcn.security.authc.AuthenticationInfo#getPrincipals() getPrincipals()} and
     ...
     * {@link #convertPrincipalsToBytes(com.hwlcn.security.subject.PrincipalCollection) converting} them to a byte
     * array and then {@link #rememberSerializedIdentity(com.hwlcn.security.subject.Subject, byte[]) remembers} that
     * byte array.
     *
     * @param subject           the subject for which the principals are being remembered.
     ...
     * <p/>
     * This implementation first {@link #serialize(com.hwlcn.security.subject.PrincipalCollection) serializes} the
     ...
     * {@link #getSerializer() serializer}'s {@link com.hwlcn.security.io.Serializer#serialize(Object) serialize} method.
     *
     ...
     * {@link com.hwlcn.security.io.Serializer#deserialize deserialize} method.
     *
    ...
    /**
     * Reacts to a failed login by immediately {@link #forgetIdentity(com.hwlcn.security.subject.Subject) forgetting} any
     ...
     * {@link #forgetIdentity(com.hwlcn.security.subject.Subject) forgets} any previously stored identity and returns.
     *

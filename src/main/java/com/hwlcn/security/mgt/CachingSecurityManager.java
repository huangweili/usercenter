...
public abstract class CachingSecurityManager implements SecurityManager, Destroyable, CacheManagerAware {
     ...
     * {@link com.hwlcn.security.cache.CacheManager CacheManager} has been set and is available for use via the
    ...
    /**
     * Destroys the {@link #getCacheManager() cacheManager} via {@link com.hwlcn.security.util.LifecycleUtils#destroy LifecycleUtils.destroy}.
     */
    public void destroy() {

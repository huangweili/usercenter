 ...
 * based around a collection of {@link com.hwlcn.security.realm.Realm}s.  This implementation delegates its
 * authentication, authorization, and session operations to wrapped {@link com.hwlcn.security.authc.Authenticator}, {@link com.hwlcn.security.authz.Authorizer}, and
 * {@link com.hwlcn.security.session.mgt.SessionManager SessionManager} instances respectively via superclass
 * implementation.
 * <p/>
 ...
 * {@link com.hwlcn.security.realm.Realm Realm}s.  Because {@code Realm} implementations usually interact with an application's data model,
 ...
 * {@code com.hwlcn.security.web.DefaultWebSecurityManager} implementation, which
...
public class DefaultSecurityManager extends SessionsSecurityManager {
    ...
    /**
     * Returns the {@code SubjectFactory} responsible for creating {@link com.hwlcn.security.subject.Subject} instances exposed to the application.
     *
     * @return the {@code SubjectFactory} responsible for creating {@link com.hwlcn.security.subject.Subject} instances exposed to the application.
     */
    ...
    /**
     * Sets the {@code SubjectFactory} responsible for creating {@link com.hwlcn.security.subject.Subject} instances exposed to the application.
     *
     * @param subjectFactory the {@code SubjectFactory} responsible for creating {@link com.hwlcn.security.subject.Subject} instances exposed to the application.
     */
     ...
     * <p/>
     * As of Shiro 1.2, this method has been deprecated in favor of {@link #save(com.hwlcn.security.subject.Subject)},
     ...
     *                for later use.
     * @see #save(com.hwlcn.security.subject.Subject)
     * @deprecated in favor of {@link #save(com.hwlcn.security.subject.Subject) save(subject)}.
     */
    @Deprecated
     ...
     * <li>Calls {@link #doCreateSubject(com.hwlcn.security.subject.SubjectContext)} to actually perform the
     * {@code Subject} instance creation.</li>
     * <li>calls {@link #save(com.hwlcn.security.subject.Subject) save(subject)} to ensure the constructed
     ...
     * @see #ensureSecurityManager(com.hwlcn.security.subject.SubjectContext)
     * @see #resolveSession(com.hwlcn.security.subject.SubjectContext)
     * @see #resolvePrincipals(com.hwlcn.security.subject.SubjectContext)
     * @see #doCreateSubject(com.hwlcn.security.subject.SubjectContext)
     * @see #save(com.hwlcn.security.subject.Subject)
     * @since 1.0
     */
     ...
     * @see SubjectFactory#createSubject(com.hwlcn.security.subject.SubjectContext)
     * @since 1.2
     */
     ...
     * {@link SubjectDAO#save(com.hwlcn.security.subject.Subject) subjectDAO.save(subject)}.
     *
     * @param subject the subject for which state will potentially be persisted
     * @see SubjectDAO#save(com.hwlcn.security.subject.Subject)
     * @since 1.2
     */
     ...
     * <p/>
     * This implementation merely delegates to the internal {@link #setSubjectDAO(SubjectDAO) subjectDAO} and calls
     * {@link SubjectDAO#delete(com.hwlcn.security.subject.Subject) delete(subject)}.
     *
     * @param subject the subject for which state will be removed
     * @see SubjectDAO#delete(com.hwlcn.security.subject.Subject)
     * @since 1.2
     */
     ...
     * <p/>
     * This has been deprecated in Shiro 1.2 in favor of the {@link #delete(com.hwlcn.security.subject.Subject) delete}
     ...
     * @deprecated in Shiro 1.2 in favor of {@link #delete(com.hwlcn.security.subject.Subject)}
     */
    @Deprecated

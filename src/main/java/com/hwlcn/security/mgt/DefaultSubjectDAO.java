 ...
 * {@link com.hwlcn.security.session.mgt.SessionManager SessionManager}) via a session ID or session key and then
 ...
 *
 * @see #isSessionStorageEnabled(com.hwlcn.security.subject.Subject)
...
public class DefaultSubjectDAO implements SubjectDAO {
    ...
    /**
     * Saves the subject's state to the subject's {@link com.hwlcn.security.subject.Subject#getSession() session} only
     ...
     * {@link com.hwlcn.security.subject.Subject#getSession() session}.  The session can be retrieved at a later time
     * (typically from a {@link com.hwlcn.security.session.mgt.SessionManager SessionManager} to be used to recreate
    ...
    /**
     * Merges the Subject's current {@link com.hwlcn.security.subject.Subject#getPrincipals()} with whatever may be in

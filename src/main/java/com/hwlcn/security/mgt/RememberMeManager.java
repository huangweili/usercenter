...
public interface RememberMeManager {
     ...
     * <p/>
     * The context map is usually populated by a {@link com.hwlcn.security.subject.Subject.Builder} implementation.
     * See the {@link SubjectFactory} class constants for Shiro's known map keys.
     *
     * @param subjectContext the contextual data, usually provided by a {@link com.hwlcn.security.subject.Subject.Builder} implementation, that
     *                       is being used to construct a {@link com.hwlcn.security.subject.Subject} instance.

 ...
 * single application.
 * <p/>
 * The interface itself primarily exists as a convenience - it extends the {@link com.hwlcn.security.authc.Authenticator},
 * {@link Authorizer}, and {@link com.hwlcn.security.session.mgt.SessionManager} interfaces, thereby consolidating
 ...
 * {@link Subject} behavior. A {@link com.hwlcn.security.subject.Subject Subject} executes
 ...
 * {@link com.hwlcn.security.SecurityUtils#getSubject() SecurityUtils.getSubject()}.
 * <p/>
...
public interface SecurityManager extends Authenticator, Authorizer, SessionManager {
     ...
     * <code>subject.{@link com.hwlcn.security.subject.Subject#login login(authenticationToken)}</code> (usually after
     * acquiring the Subject by calling {@link com.hwlcn.security.SecurityUtils#getSubject() SecurityUtils.getSubject()}).
     * <p/>
     ...
     * @throws com.hwlcn.security.authc.AuthenticationException if the login attempt failed.
     * @since 1.0
     */
     ...
     * <code>{@link com.hwlcn.security.subject.Subject#logout Subject.logout()}</code>, not the

...
/**
 * Evaluates whether or not Shiro may use a {@code Subject}'s {@link com.hwlcn.security.session.Session Session}
...
public interface SessionStorageEvaluator {
     ...
     * {@link com.hwlcn.security.subject.Subject#getSession() session} may be used to persist that Subject's

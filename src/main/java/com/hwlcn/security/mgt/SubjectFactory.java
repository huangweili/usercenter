...
/**
 * A {@code SubjectFactory} is responsible for constructing {@link com.hwlcn.security.subject.Subject Subject} instances as needed.
 *
 * @since 1.0
 */
public interface SubjectFactory {
     ...
     * or {@code resolve*} methods.  All other data is available as map {@link java.util.Map#get attribute}s.
     *

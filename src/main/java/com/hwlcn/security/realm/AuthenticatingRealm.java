 ...
 * (and configuring Shiro with a {@link com.hwlcn.security.cache.CacheManager} of course), but <b>NOTE:</b>
 * <p/>
 * <b>ONLY enable authentication caching if either of the following is true for your realm implementation:</b>
 * <ul>
 * <li>The {@link #doGetAuthenticationInfo(com.hwlcn.security.authc.AuthenticationToken) doGetAuthenticationInfo}
 * implementation returns {@code AuthenticationInfo} instances where the
 * {@link com.hwlcn.security.authc.AuthenticationInfo#getCredentials() credentials} are securely obfuscated and NOT
 * plaintext (raw) credentials. For example,
 * if your realm references accounts with passwords, that the {@code AuthenticationInfo}'s
 * {@link com.hwlcn.security.authc.AuthenticationInfo#getCredentials() credentials} are safely hashed and salted or otherwise
 * fully encrypted.<br/><br/></li>
 * <li>The {@link #doGetAuthenticationInfo(com.hwlcn.security.authc.AuthenticationToken) doGetAuthenticationInfo}
 * implementation returns {@code AuthenticationInfo} instances where the
 * {@link com.hwlcn.security.authc.AuthenticationInfo#getCredentials() credentials} are plaintext (raw) <b>AND</b> the
 ...
 * {@link #getAuthenticationCacheKey(com.hwlcn.security.authc.AuthenticationToken)} and
 * {@link #getAuthenticationCacheKey(com.hwlcn.security.subject.PrincipalCollection)} methods return the exact same value.
 * <p/>
 * The default implementations of these methods expect that the
 * {@link com.hwlcn.security.authc.AuthenticationToken#getPrincipal()} (what the user submits during login) and
 * {@link #getAvailablePrincipal(com.hwlcn.security.subject.PrincipalCollection) getAvailablePrincipal} (what is returned
 ...
 * {@link #getAuthenticationCacheKey(com.hwlcn.security.authc.AuthenticationToken) getAuthenticationCacheKey(token)} or
 * {@link #getAuthenticationCacheKey(com.hwlcn.security.subject.PrincipalCollection) getAuthenticationCacheKey(principals)}
 ...
 * If the return values from {@link #getAuthenticationCacheKey(com.hwlcn.security.authc.AuthenticationToken)} and
 * {@link #getAuthenticationCacheKey(com.hwlcn.security.subject.PrincipalCollection)} are not identical, cached
...
public abstract class AuthenticatingRealm extends CachingRealm implements Initializable {
     ...
     * default implementation of the {@link Realm#supports(com.hwlcn.security.authc.AuthenticationToken)} method to
     ...
     * value is a {@link com.hwlcn.security.authc.credential.SimpleCredentialsMatcher SimpleCredentialsMatcher} instance.
     *
     ...
     * {@link com.hwlcn.security.authc.credential.SimpleCredentialsMatcher} instance.
     *
     ...
     * <p/>
     * <p>The default value is <tt>{@link com.hwlcn.security.authc.UsernamePasswordToken UsernamePasswordToken.class}</tt>, since
     ...
     * {@link com.hwlcn.security.authc.UsernamePasswordToken UsernamePasswordToken.class} to support the majority of applications.
     *
    ...
    /**
     * Sets an explicit {@link com.hwlcn.security.cache.Cache} instance to use for authentication caching.  If not set and authentication
     ...
     *
     * @param authenticationCache an explicit {@link com.hwlcn.security.cache.Cache} instance to use for authentication caching or
    ...
    /**
     * Returns a {@link com.hwlcn.security.cache.Cache} instance to use for authentication caching, or {@code null} if no cache has been
     * set.
     *
     * @return a {@link com.hwlcn.security.cache.Cache} instance to use for authentication caching, or {@code null} if no cache has been
     *         set.
     * @see #setAuthenticationCache(com.hwlcn.security.cache.Cache)
     * @see #isAuthenticationCachingEnabled()
     * @since 1.2
     */
    ...
    /**
     * Returns the name of a {@link com.hwlcn.security.cache.Cache} to lookup from any available {@link #getCacheManager() cacheManager} if
     * a cache is not explicitly configured via {@link #setAuthenticationCache(com.hwlcn.security.cache.Cache)}.
     * <p/>
     ...
     * of this page in the class-level JavaDoc.
     *
     * @return the name of a {@link com.hwlcn.security.cache.Cache} to lookup from any available {@link #getCacheManager() cacheManager} if
     *         a cache is not explicitly configured via {@link #setAuthenticationCache(com.hwlcn.security.cache.Cache)}.
     * @see #isAuthenticationCachingEnabled()
     * @since 1.2
     */
    ...
    /**
     * Sets the name of a {@link com.hwlcn.security.cache.Cache} to lookup from any available {@link #getCacheManager() cacheManager} if
     * a cache is not explicitly configured via {@link #setAuthenticationCache(com.hwlcn.security.cache.Cache)}.
     * <p/>
     * This name will only be used to look up a cache if authentication caching is
     * {@link #isAuthenticationCachingEnabled() enabled}.
     *
     * @param authenticationCacheName the name of a {@link com.hwlcn.security.cache.Cache} to lookup from any available
     *                                {@link #getCacheManager() cacheManager} if a cache is not explicitly configured
     *                                via {@link #setAuthenticationCache(com.hwlcn.security.cache.Cache)}.
     * @see #isAuthenticationCachingEnabled()
     * @since 1.2
     */
    ...
    /**
     * Returns {@code true} if authentication caching should be utilized if a {@link com.hwlcn.security.cache.CacheManager} has been
    ...
    /**
     * Sets whether or not authentication caching should be utilized if a {@link com.hwlcn.security.cache.CacheManager} has been
     * {@link #setCacheManager(com.hwlcn.security.cache.CacheManager) configured}, {@code false} otherwise.
     * <p/>
    ...
    /**
     * Returns any available {@link com.hwlcn.security.cache.Cache} instance to use for authentication caching.  This functions as follows:
     * <ol>
     * <li>If an {@link #setAuthenticationCache(com.hwlcn.security.cache.Cache) authenticationCache} has been explicitly
     ...
     * </ol>
     *
     * @return any available {@link com.hwlcn.security.cache.Cache} instance to use for authentication caching.
     */
     ...
     * {@link #isAuthenticationCachingEnabled(com.hwlcn.security.authc.AuthenticationToken, com.hwlcn.security.authc.AuthenticationInfo) isEnabled}
     ...
     * {@link com.hwlcn.security.authc.AuthenticationToken} and/or {@link com.hwlcn.security.authc.AuthenticationInfo}, {@code false} otherwise.
     * <p/>
     ...
     *              {@link #doGetAuthenticationInfo(com.hwlcn.security.authc.AuthenticationToken)}
     ...
     * <ol>
     * <li>It attempts to acquire any cached {@link com.hwlcn.security.authc.AuthenticationInfo} corresponding to the specified
     * {@link com.hwlcn.security.authc.AuthenticationToken} argument.  If a cached value is found, it will be used for credentials matching,
     * alleviating the need to perform any lookups with a data source.</li>
     * <li>If there is no cached {@link com.hwlcn.security.authc.AuthenticationInfo} found, delegate to the
     * {@link #doGetAuthenticationInfo(com.hwlcn.security.authc.AuthenticationToken)} method to perform the actual
     * lookup.  If authentication caching is enabled and possible, any returned info object will be
     * {@link #cacheAuthenticationInfoIfPossible(com.hwlcn.security.authc.AuthenticationToken, com.hwlcn.security.authc.AuthenticationInfo) cached}
     ...
     * @throws com.hwlcn.security.authc.AuthenticationException if authentication failed.
     */
     ...
     * {@code AuthenticationInfo}'s credentials, and if not, throws an {@link com.hwlcn.security.authc.AuthenticationException}.
     *
     * @param token the submitted authentication token
     * @param info  the AuthenticationInfo corresponding to the given {@code token}
     * @throws com.hwlcn.security.authc.AuthenticationException if the token's credentials do not match the stored account credentials.
     */
    ...
    /**
     * Returns the key under which {@link com.hwlcn.security.authc.AuthenticationInfo} instances are cached if authentication caching is enabled.
     * This implementation defaults to returning the token's
     * {@link com.hwlcn.security.authc.AuthenticationToken#getPrincipal() principal}, which is usually a username in
     * most applications.
     ...
     * must ensure the {@link #getAuthenticationCacheKey(com.hwlcn.security.subject.PrincipalCollection)} method returns
     * the same value as this method.
     *
     * @param token the authentication token for which any successful authentication will be cached.
     * @return the cache key to use to cache the associated {@link com.hwlcn.security.authc.AuthenticationInfo} after a successful authentication.
     * @since 1.2
     */
     ...
     * {@link #getAvailablePrincipal(com.hwlcn.security.subject.PrincipalCollection)}, which returns the primary principal
     * associated with this particular Realm.
     * <h3>Cache Invalidation on Logout</h3>
     * <b>NOTE:</b> If you want to be able to invalidate an account's cached {@code AuthenticationInfo} on logout, you
     * must ensure that this method returns the same value as the
     * {@link #getAuthenticationCacheKey(com.hwlcn.security.authc.AuthenticationToken)} method!
     *
     * @param principals the principals of the account for which to set or remove cached {@code AuthenticationInfo}.
     * @return the cache key to use when looking up cached {@link com.hwlcn.security.authc.AuthenticationInfo} instances.
     * @since 1.2
     */
     ...
     * {@link #clearCachedAuthenticationInfo(com.hwlcn.security.subject.PrincipalCollection)}.
     ...
     * {@link #doGetAuthenticationInfo(com.hwlcn.security.authc.AuthenticationToken) doGetAuthenticationInfo}, and the
     ...
     * @see #clearCache(com.hwlcn.security.subject.PrincipalCollection)
     * @since 1.2
     */
     ...
     * @return an {@link com.hwlcn.security.authc.AuthenticationInfo} object containing account data resulting from the
     *         authentication ONLY if the lookup is successful (i.e. account exists and is valid, etc.)
     * @throws com.hwlcn.security.authc.AuthenticationException if there is an error acquiring data or performing

 ...
 * {@link #getAvailablePrincipal(com.hwlcn.security.subject.PrincipalCollection)}, which is useful across all
 ...
 * @see #onLogout(com.hwlcn.security.subject.PrincipalCollection)
 * @see #getAvailablePrincipal(com.hwlcn.security.subject.PrincipalCollection)
 * @since 0.9
 */
public abstract class CachingRealm implements Realm, Nameable, CacheManagerAware, LogoutAware {
    ...
    /**
     * Returns {@code true} if caching should be used if a {@link com.hwlcn.security.cache.CacheManager} has been
     ...
     *
     * @return {@code true} if caching will be globally enabled if a {@link com.hwlcn.security.cache.CacheManager} has been
    ...
    /**
     * Sets whether or not caching should be used if a {@link com.hwlcn.security.cache.CacheManager} has been
     * {@link #setCacheManager(com.hwlcn.security.cache.CacheManager) configured}.
     *
     ...
     * {@link com.hwlcn.security.cache.CacheManager} instance being set on the realm instance via the
     * {@link #setCacheManager(com.hwlcn.security.cache.CacheManager)} mutator.
     */
     ...
     * <p/>
     * This default implementation merely calls {@link #clearCache(com.hwlcn.security.subject.PrincipalCollection)}.
     *
     ...
     * to {@link #doClearCache(com.hwlcn.security.subject.PrincipalCollection)}.
     *
     ...
     * from the PrincipalCollection via {@link com.hwlcn.security.subject.PrincipalCollection#getPrimaryPrincipal()}.</li>

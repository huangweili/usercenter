 ...
 * work in any environment where {@link com.hwlcn.security.realm.Realm Realm} instances are bound in JNDI instead of using
...
public class JndiRealmFactory extends JndiLocator implements RealmFactory {
     ...
     * @see #setJndiNames(java.util.Collection)
     */
     ...
     * {@link com.hwlcn.security.realm.Realm Realm}.  The Realms will be made available to the SecurityManager in the order
     * they are defined.
     *

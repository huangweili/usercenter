 ...
 * configuration template used to acquire JNDI {@link javax.naming.ldap.LdapContext} connections at runtime.  The
 ...
 * one used to acquire the {@link javax.naming.ldap.LdapContext}.
 * <p/>
...
public class JndiLdapContextFactory implements LdapContextFactory {
     ...
     * {@link javax.naming.Context#SECURITY_AUTHENTICATION} property.
     * <p/>
     ...
     * <p/>
     * This is a wrapper method for setting the JNDI environment's {@link javax.naming.Context#INITIAL_CONTEXT_FACTORY} property.
     *
     ...
     * but can be overridden to use custom LDAP factories.
     * <p/>
     * This is a wrapper method for getting the JNDI environment's {@link javax.naming.Context#INITIAL_CONTEXT_FACTORY} property.
     *
    ...
    /**
     * Returns the base JNDI environment template to use when acquiring an LDAP connection (an {@link javax.naming.ldap.LdapContext}).
     ...
     * acquire the {@link javax.naming.ldap.LdapContext} at runtime.
     * <p/>
     ...
     *
     * @return the base JNDI environment template to use when acquiring an LDAP connection (an {@link javax.naming.ldap.LdapContext})
     */
     ...
     * The merged environment instance is what is used to acquire the connection ({@link javax.naming.ldap.LdapContext}) at runtime.
     *
     ...
     * @throws javax.naming.NamingException if there is a problem connecting to the LDAP directory
     */
     ...
     * @throws javax.naming.NamingException if a problem occurs creating the connection
     */

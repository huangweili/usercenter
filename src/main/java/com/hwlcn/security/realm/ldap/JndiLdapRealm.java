...
/**
 * An LDAP {@link com.hwlcn.security.realm.Realm Realm} implementation utilizing Sun's/Oracle's
 ...
 * {@link com.hwlcn.security.authc.AuthenticationToken#getPrincipal() principal} is a simple username, but the
 ...
 * {@link #doGetAuthorizationInfo(com.hwlcn.security.subject.PrincipalCollection)} implementation returning {@code null}.
...
public class JndiLdapRealm extends AuthorizingRealm {
     ...
     * {@link com.hwlcn.security.authc.AuthenticationToken#getPrincipal() principal} will be used as the LDAP principal.  This is likely
    ...
    /**
     * Delegates to {@link #queryForAuthenticationInfo(com.hwlcn.security.authc.AuthenticationToken, LdapContextFactory)},
     * wrapping any {@link javax.naming.NamingException}s in a Shiro {@link com.hwlcn.security.authc.AuthenticationException} to satisfy the parent method
     * signature.
     *
     * @param token the authentication token containing the user's principal and credentials.
     * @return the {@link com.hwlcn.security.authc.AuthenticationInfo} acquired after a successful authentication attempt
     * @throws com.hwlcn.security.authc.AuthenticationException
     *          if the authentication attempt fails or if a
     *          {@link javax.naming.NamingException} occurs.
     */
     ...
     * {@link com.hwlcn.security.authc.AuthenticationToken#getPrincipal() principal} is a {@code String}, and if so,
     ...
     *
     * @param token the {@link com.hwlcn.security.authc.AuthenticationToken} submitted during the authentication process
     ...
     * {@link #getLdapPrincipal(com.hwlcn.security.authc.AuthenticationToken) discovered principal} and provided
     * {@link com.hwlcn.security.authc.AuthenticationToken#getCredentials() credentials}.  If the connection opens successfully, the
     * authentication attempt is immediately considered successful and a new
     * {@link com.hwlcn.security.authc.AuthenticationInfo} instance is
     * {@link #createAuthenticationInfo(com.hwlcn.security.authc.AuthenticationToken, Object, Object, javax.naming.ldap.LdapContext) created}
     * and returned.  If the connection cannot be opened, either because LDAP authentication failed or some other
     * JNDI problem, an {@link javax.naming.NamingException} will be thrown.
     *
     * @param token              the submitted authentication token that triggered the authentication attempt.
     * @param ldapContextFactory factory used to retrieve LDAP connections.
     * @return an {@link com.hwlcn.security.authc.AuthenticationInfo} instance representing the authenticated user's information.
     * @throws javax.naming.NamingException if any LDAP errors occur.
     */
    ...
    /**
     * Returns the {@link com.hwlcn.security.authc.AuthenticationInfo} resulting from a Subject's successful LDAP authentication attempt.
     * <p/>
     ...
     *                        {@link com.hwlcn.security.authc.AuthenticationToken#getPrincipal() principal}, this value is usually a constructed
     ...
     * @return the {@link com.hwlcn.security.authc.AuthenticationInfo} resulting from a Subject's successful LDAP authentication attempt.
     * @throws javax.naming.NamingException if there was any problem using the {@code LdapContext}
     */
    @SuppressWarnings({"UnusedDeclaration"})

...
/**
 * Implementation of the {@link com.hwlcn.security.session.Session Session} interface that proxies another <code>Session</code>, but does not
 ...
 * proxy will immediately result in an {@link com.hwlcn.security.session.InvalidSessionException} being thrown:
 * <ul>
 * <li>{@link com.hwlcn.security.session.Session#setTimeout(long) Session.setTimeout(long)}</li>
 * <li>{@link com.hwlcn.security.session.Session#touch() Session.touch()}</li>
 * <li>{@link com.hwlcn.security.session.Session#stop() Session.stop()}</li>
 * <li>{@link com.hwlcn.security.session.Session#setAttribute(Object, Object) Session.setAttribute(key,value)}</li>
 * <li>{@link com.hwlcn.security.session.Session#removeAttribute(Object) Session.removeAttribute(key)}</li>
 * </ul>
...
public class ImmutableProxiedSession extends ProxiedSession {
     ...
     *
     * @throws com.hwlcn.security.session.InvalidSessionException in all cases - used by the Session 'write' method implementations.
     */

 ...
 * for the creation, persistence and removal of {@link com.hwlcn.security.session.Session Session} instances and their
 * lifecycles.
 *
 * @since 1.0
 */
public interface NativeSessionManager extends SessionManager {
     ...
     * @see com.hwlcn.security.session.Session#getStartTimestamp()
     */
     ...
     * @see com.hwlcn.security.session.Session#getLastAccessTime()
     * @see com.hwlcn.security.session.Session#touch()
     */
     ...
     * an {@link com.hwlcn.security.session.InvalidSessionException} indicating that the session id is invalid.  This
     * might be preferred to be used instead of {@link #isValid} since any exception thrown will definitively explain
     * the reason for invalidation.
     *
     * @param key the session key to use to look up the target session.
     * @throws com.hwlcn.security.session.InvalidSessionException
     ...
     * @see com.hwlcn.security.session.Session#stop
     */
     ...
     * @see com.hwlcn.security.session.Session#getAttributeKeys()
     */
     ...
     * @see com.hwlcn.security.session.Session#getAttribute(Object key)
     */
     ...
     * @throws InvalidSessionException if the specified session has stopped or expired prior to calling this method.
     * @see com.hwlcn.security.session.Session#setAttribute(Object key, Object value)
     */
     ...
     * @throws InvalidSessionException if the specified session has stopped or expired prior to calling this method.
     * @see com.hwlcn.security.session.Session#removeAttribute(Object key)
     */

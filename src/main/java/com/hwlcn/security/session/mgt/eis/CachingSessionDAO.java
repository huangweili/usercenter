...
public abstract class CachingSessionDAO extends AbstractSessionDAO implements CacheManagerAware {
     ...
     * it will be {@link com.hwlcn.security.cache.CacheManager#getCache(String) acquired} from the {@link #setCacheManager configured}
     ...
     * {@link #doUpdate(com.hwlcn.security.session.Session)}.  If the session is a {@link com.hwlcn.security.session.mgt.ValidatingSession}, it will
     * be added to the cache only if it is {@link com.hwlcn.security.session.mgt.ValidatingSession#isValid()} and if invalid, will be removed from the

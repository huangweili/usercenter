...
/**
 * Generates session IDs by using a {@link java.util.Random} instance to generate random IDs. The default {@code Random}
...
public class RandomSessionIdGenerator implements SessionIdGenerator {
    ...
    /**
     * Returns the String value of the configured {@link java.util.Random}'s {@link java.util.Random#nextLong() nextLong()} invocation.
     *
     * @param session the {@link Session} instance to which the ID will be applied.
     * @return the String value of the configured {@link java.util.Random}'s {@link java.util.Random#nextLong()} invocation.
     */

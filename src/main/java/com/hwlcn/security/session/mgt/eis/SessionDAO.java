...
/**
 * Data Access Object design pattern specification to enable {@link com.hwlcn.security.session.Session} access to an
 * EIS (Enterprise Information System).  It provides your four typical CRUD methods:
 * {@link #create}, {@link #readSession(java.io.Serializable)}, {@link #update(com.hwlcn.security.session.Session)},
 * and {@link #delete(com.hwlcn.security.session.Session)}.
 * <p/>
 * The remaining {@link #getActiveSessions()} method exists as a support mechanism to pre-emptively orphaned sessions,
 * typically by {@link com.hwlcn.security.session.mgt.ValidatingSessionManager ValidatingSessionManager}s), and should
...
public interface SessionDAO {
     ...
     * <p/>
     * After this method is invoked, the {@link com.hwlcn.security.session.Session#getId()}
     ...
     *
     * @param session the {@link com.hwlcn.security.session.Session} object to create in the EIS.
     ...
     * @throws com.hwlcn.security.session.UnknownSessionException
     ...
     * {@link com.hwlcn.security.session.Session#getLastAccessTime() lastAccessTime}.
     * <h4>Smart Results</h4>
     ...
     * {@link com.hwlcn.security.session.mgt.SimpleSession SimpleSession}s were being stored):
     * <pre>

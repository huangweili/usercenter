...
public interface SessionIdGenerator {
     ...
     *
     * @param session the {@link com.hwlcn.security.session.Session} instance to which the ID will be applied.
     * @return the id to assign to the specified {@link com.hwlcn.security.session.Session} instance before adding a record to the EIS data store.
     */

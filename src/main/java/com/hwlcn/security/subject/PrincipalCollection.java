...
public interface PrincipalCollection extends Iterable, Serializable {
     ...
     * {@link com.hwlcn.security.authc.pam.AuthenticationStrategy}.  An {@code AuthenticationStrategy} has exact control
     * over the {@link PrincipalCollection} returned at the end of an authentication attempt via the
     * <code>AuthenticationStrategy#{@link com.hwlcn.security.authc.pam.AuthenticationStrategy#afterAllAttempts(com.hwlcn.security.authc.AuthenticationToken, com.hwlcn.security.authc.AuthenticationInfo) afterAllAttempts}</code>
     * implementation.
     *

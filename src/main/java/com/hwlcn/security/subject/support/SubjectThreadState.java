 ...
 * {@code SecurityUtils.}{@link com.hwlcn.security.SecurityUtils#getSubject() getSubject()} calls)
 * during a thread's execution.
 * <p/>
 * The {@link #bind bind} method will bind a {@link Subject} and a
 * {@link com.hwlcn.security.mgt.SecurityManager SecurityManager} to the {@link com.hwlcn.security.util.ThreadContext} so they can be retrieved
 * from the {@code ThreadContext} later by any
 * {@code SecurityUtils.}{@link com.hwlcn.security.SecurityUtils#getSubject() getSubject()} calls that might occur during
...
public class SubjectThreadState implements ThreadState {
     ...
     * thread
     *
     * @param subject the {@code Subject} instance to bind and unbind from the {@link com.hwlcn.security.util.ThreadContext}.
     */
    ...
    /**
     * Binds a {@link Subject} and {@link com.hwlcn.security.mgt.SecurityManager SecurityManager} to the
     * {@link com.hwlcn.security.util.ThreadContext} so they can be retrieved later by any
     * {@code SecurityUtils.}{@link com.hwlcn.security.SecurityUtils#getSubject() getSubject()} calls that might occur
     * during the thread's execution.
     * <p/>
     * Prior to binding, the {@code ThreadContext}'s existing {@link com.hwlcn.security.util.ThreadContext#getResources() resources} are
    ...
    /**
     * {@link com.hwlcn.security.util.ThreadContext#remove Remove}s all thread-state that was bound by this instance.  If any previous
    ...
    /**
     * Completely {@link com.hwlcn.security.util.ThreadContext#remove removes} the {@code ThreadContext} state.  Typically this method should

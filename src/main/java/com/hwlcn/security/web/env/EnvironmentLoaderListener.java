 ...
 * {@link com.hwlcn.security.web.env.WebEnvironment} at ServletContext startup and shutdown respectively.  This class exists only to
 * implement the {@link javax.servlet.ServletContextListener} interface. All 'real' logic is done in the parent
 * {@link com.hwlcn.security.web.env.EnvironmentLoader} class.
 * <h2>Usage</h2>
 * Define the following in {@code web.xml}:
 * <pre>
 * &lt;listener&gt;
 *     &lt;listener-class&gt;<code>com.hwlcn.security.web.env.EnvironmentLoaderListener</code>&lt;/listener-class&gt;
 * &lt;/listener&gt;
 * </pre>
 ...
 * {@link com.hwlcn.security.web.env.EnvironmentLoader} JavaDoc.
 * <h2>Shiro Filter</h2>
 * This listener is almost always defined in conjunction with the
 * {@link com.hwlcn.security.web.servlet.SecurityFilter SecurityFilter} to ensure security operations for web requests.  Please
 * see the {@link com.hwlcn.security.web.servlet.SecurityFilter SecurityFilter} JavaDoc for more.
 *
 * @see com.hwlcn.security.web.env.EnvironmentLoader
 * @see com.hwlcn.security.web.servlet.SecurityFilter SecurityFilter
 * @since 1.2
 */

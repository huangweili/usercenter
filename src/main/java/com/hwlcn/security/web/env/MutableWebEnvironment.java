...
public interface MutableWebEnvironment extends WebEnvironment {
    ...
    /**
     * Sets the {@link com.hwlcn.security.web.env.WebEnvironment}'s associated {@code ServletContext} instance.  Invoking this method merely
     * makes the {@code ServletContext} available to the underlying instance - it does not trigger initialization
     * behavior.
     *
     * @param servletContext the {@link com.hwlcn.security.web.env.WebEnvironment}'s associated {@code ServletContext} instance.
     */
